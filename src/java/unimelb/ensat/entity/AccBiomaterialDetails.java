/**
 * entity class for AccBiomaterialDetails
 */
 ...
 */
@XmlRootElement
public class AccBiomaterialDetails implements Serializable {

    private static final long serialVersionUID = 1L;

    private int ensat_id;
    private String bio_id;
    private Date biomaterial_date;
    ...
    public AccBiomaterialDetails() {
    }

    public AccBiomaterialDetails(int ensat_id, String bio_id, Date biomaterial_date, String material, int aliquot_sequence_id, String freezer_number, String freezershelf_number, String rack_number, String shelf_number, String box_number, String position_number, String center_id, String destination_center_id, Date transfered_date, String status, int transfer_group_id, int acc_biomaterial_transfer_id) {
    ...
    public AccBiomaterialDetails(int ensat_id, String bio_id, Date biomaterial_date, String material, int aliquot_sequence_id, String freezer_number, String freezershelf_number, String rack_number, String shelf_number, String box_number, String position_number, String center_id) {
        this.ensat_id = ensat_id;
        this.bio_id = bio_id;
        this.biomaterial_date = biomaterial_date;
        this.material = material;
    ...
    public AccBiomaterialDetails(Date biomaterial_date) {
        this.biomaterial_date = biomaterial_date;
    }

    public AccBiomaterialDetails(int ensat_id, String bio_id, Date biomaterial_date) {
        this.ensat_id = ensat_id;
        this.bio_id = bio_id;
        this.biomaterial_date = biomaterial_date;
    }
    ...
    public Date getBiomaterial_date() {
        return biomaterial_date;
    }

    public void setBiomaterial_date(Date biomaterial_date) {
        this.biomaterial_date = biomaterial_date;
    }
